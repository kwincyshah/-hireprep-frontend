...
const questions = [
  ...
  { id: 'q2', label: 'How do you convince customer to purchase' },
  { id: 'q3', label: 'Are you comfortable travelling' },
  { id: 'q4', label: 'Why should we hire you' },
    ...
    <div className="category-page">
      ...
      <form className="category-content" onSubmit={handleResult}>
        <div className="category-card">
          <h1 className="category-title">SALES EXECUTIVE</h1>
