...
const questions = [
  ...
  { id: 'q2', label: 'How many company have you applied' },
  { id: 'q3', label: 'How do you find trand' },
  { id: 'q4', label: 'How do you measure the success of a  campaign' },
...
function DigitalMarketing() {
  ...
  const handleResult = async (e) => {
    ...
    try {
      const res = await fetch('https://hireprep-backend-px4h.onrender.com/api/score/digital-marketing', {
        method: 'POST',
    ...
    <div className="category-page">
      ...
      <form className="category-content" onSubmit={handleResult}>
        <div className="category-card">
          <h1 className="category-title">DIGITAL MARKETING</h1>
