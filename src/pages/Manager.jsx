...
const questions = [
  ...
  { id: 'q2', label: 'Why did you choise this field' },
  { id: 'q3', label: 'How do you delegate task to your team members' },
  { id: 'q4', label: 'Where do you see yourself in 5 years' },
    ...
    <div className="category-page">
      ...
      <form className="category-content" onSubmit={handleResult}>
        <div className="category-card">
          <h1 className="category-title">MANAGER</h1>
